...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" --git-dir=.git show-ref "v2.6.1"
  WORKING_DIRECTORY "D:/homegrowh_harness/package/tools/filesystems/build-config-check/_deps/cli11-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/homegrowh_harness/package/tools/filesystems/build-config-check/_deps/cli11-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/homegrowh_harness/package/tools/filesystems/build-config-check/_deps/cli11-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
